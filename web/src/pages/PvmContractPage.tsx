		...
		<ContractProofOfExistencePage
			...
			description={
				<>
					...
					<code className="bg-gray-800 px-1 rounded">resolc</code> to PolkaVM (RISC-V)
					bytecode, deployed via pallet-revive. Same frontend code — the eth-rpc proxy
					provides an identical interface.
				</>
			}
			contractKind="pvm"
			accentColor="green"
